 ...
 * which receives a suffix, and checks if the filename contains that suffix.
 */
public class SuffixFilter extends Filter {
    /*the suffix to check if the file has in it name.*/
     ...
     * @param IsNot a boolean if the suffix should not be in the name or it should.
     ...
     */
    SuffixFilter(String[] args, boolean IsNot) throws InvalidInputException {
    ...
    public boolean accept(File file) {
        return isNot != file.getName().endsWith(suffix);
    }
}
