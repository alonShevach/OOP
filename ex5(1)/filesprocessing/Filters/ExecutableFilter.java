 ...
 * which receives a file and checks if it is executable.
 */
public class ExecutableFilter extends Filter {

    /* a boolean represents if it should be Executable of not*/
     ...
     * @param IsNot a boolean if it should not be Executable or it should.
     ...
     */
    ExecutableFilter(String[] args, boolean IsNot) throws InvalidInputException {
    ...
    public boolean accept(File file) {
        return (file.canExecute() == yesOrNo) != isNot;
    }
}
